...
<template>
  <div id="foreach" @scroll="handleScroll">
    <div class="banner">这里有一个banner卡位</div>
    <VRender ref="render" :total="1000" :remain="20" :height="100">
      <div v-for="(item, index) in items" :key="index" :style="{ height: '100px' }" class="demo">
